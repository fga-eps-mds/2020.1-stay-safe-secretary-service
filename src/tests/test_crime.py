...
class TestCrime(unittest.TestCase):
    ...
    def test_get_all_crimes(self):
        ...
        """
        result, status = controller.get_all_crimes(None, None, None, None, None)
    ...
    def test_get_crimes_from_one_secretary(self):
        ...
        for secretary in secretarys:
            result, status = controller.get_all_crimes(secretary, None, None, None, None)
            self.assertEqual(status, 200)
    ...
    def test_get_crimes_from_invalid_secretary(self):
        ...
        """
        result, status = controller.get_all_crimes("mt", None, None, None, None)
    ...
    def test_get_crimes_by_crime_nature(self):
        ...
        """
        result, status = controller.get_all_crimes(None, "Roubo a Transeunte", None, None, None)
        self.assertEqual(status, 200)
    ...
    def test_get_crimes_by_invalid_crime_nature(self):
        ...
        """
        result, status = controller.get_all_crimes(None, "Roubo a carga", None, None, None)
